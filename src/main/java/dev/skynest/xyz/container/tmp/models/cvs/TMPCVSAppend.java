...
public class TMPCVSAppend<T extends IData> implements TMP<T> {
    ...
    private void appendLineToFile(String line) {
        ...
        try (CsvWriter writer = CsvWriter.builder().build(csvFile.toPath(), StandardCharsets.UTF_8, StandardOpenOption.WRITE, StandardOpenOption.APPEND)) {
